...
def selected():
    global img_path, img
    def Open_the_file():
        value = tmsg.askquestion("Opening The Picture?", "Are You Sure You Open The Picture?")
        if value == "yes":
            aaaa=12
        else:
            tmsg.showerror("Error","Your System Crashed You Press-No.")
            exit()
    Open_the_file()
...
def save():
    ...
    if file:
        ...
        tmsg.showinfo("Congratulations!!", "Your Picture Save Successfully")
